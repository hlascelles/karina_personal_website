...
**Coffee (if you don't ask for bean options, you won't get the cool stuff):**
...
* Hackney: Knees Up, Lodestar Coffee, Paradox Design + Coffee (no toilet).
* Day Trip in Dalston.
* Morr in Islington.
* Liverpool Street: Snoozzze Coffee, Commons at Old Street Works, Lift Coffee (also in Kensington), Origin Coffee (Charlotte Road), High Grade Coffee (no toilet).
* Soho: [Qima Cafe](https://qimacafe.com/), Kiss the Hippo (several locations).
