...
* &#9733; Shaanxi History Museum (34.224938, 108.950597). Halls 1, 2 and 3 were my favourite; 6 and 7 were under renovation. The ticket check is at the entrance to the courtyard, not the museum building, so bring a lunchbox for a lovely picnic in the courtyard (or in the basement if it is raining). This is an outstanding museum and tickets are free, so they are hard to get. See on WeChat how many days in advance they become available, create an itinerary in the WeChat Mini Program (enter date, time and passport numbers) on the morning of the booking day (it doesn't matter when exactly you do it), then press "book" at 17:00 when the tickets are released. If you can't get tickets, explore Xi'an Museum instead.
...
* Both my China Mobile sim card and my foreign e-sim were struggling in Chengdu. Maybe just a coincidence. 
...
**Navigation:**
* To plan your trip you'll want to know where things are. This won't be straightforward, but armed with 3 mapping apps you'll figure it out. 
...
* **Organic Maps** or any other offline OpenStreetMap-based app. Advantages: You can download an offline map of China. You can save locations using 16 different colours, so you won't be confused which one is your hotel and where the vegetarian restaurants are. Metro maps are available as a layer you can turn on and off, and you can get directions by metro (but not buses). Disadvantages: Since it is an offline map, some information is outdated. There are no reviews or photos. Just like on Google Maps, for some places locations might be completely wrong, and many places are not on the map. But if you figure out the location from Amap or a description like "across the road from Exit 5B of Xiaoshizi station" you can save it as a (usefully colour-coded) pin.
...
* Yes, you guessed it - these coordinates match only with Organic Maps (and maybe other OpenStreetMap-based apps). Do not look for these coordinates in Google Maps because both maps are wrong and in different ways... see [Anastasia's article](https://medium.com/@anastasia.bizyayeva/every-map-of-china-is-wrong-bc2bce145db2). And Amap doesn't work with coordinates.
...
* Once I arrived in China, I could no longer log into [https://www.12306.cn/en/index.html](https://www.12306.cn/en/index.html). Eventually I discovered that I could log into [https://www.12306.cn/index/](https://www.12306.cn/index/) and easily purchase more tickets or cancel some. 
...
* In all the cities I've visited, I was able to easily use public transport (metro and buses) by using AliPay. Simply click on Transport, make sure that the city name on the top of the screen is correct, select Metro or Bus, and press "Get Now" to obtain a travel card. You only need to do it once in every city. 
* Didi is the Chinese equivalent of Uber. This was the only type of taxi I used. Names of some locations were different from Amap, but in general I didn't have many problems. Waiting times were always surprisingly short, even for 2 hour rides. You can use Didi through a payment app (AliPay or WeChat) to save yourself the hassle of setting up a new account and adding your payment information. Just click on the Didi icon in AliPay and it works brilliantly (just don't forget to pay for the ride afterwards, your card won't be charged automatically). I only tried it once through WeChat and got so many adverts, that I never wanted to do it again. If need be, you can also get Didi through Didi app, Amap or Baidu Maps.
* If you take a Didi for a long drive that includes paid highways, you might have to pay twice the amount of highway fees to allow the driver to return home without paying out-of-pocket. This will be handled in the app, the driver won't ask you for money.
* If a Didi driver is asking you for a code, he wants the last few digits of your phone number.
* Many things are shut on Mondays, making them ideal for long distance travel, hiking and having fun with autonomous taxis.

**&#9733; Autonomous taxis:**
* If you've never been in an autonomous car before, trying one in China will be much fun.
...
* In Pony.ai app, the pickup location is green; the drop off location is orange and can be changed during the ride. 
* McDonalds (39.804571, 116.48426) across the road from the station was one of the available pickup locations. After a bit of a wait, a car marked with BJHAD logo (in the shape of a car) arrived and it unlocked itself once my phone was sufficiently close to it. 
* I changed my drop off location several times during the ride to prolong my experience in the autonomous car. Walking through this area is really boring, so try to end your ride near a metro station. After the ride, it took me a while to figure out how to pay for it; hopefully they'll make it more obvious in the app by the time you use it.
* To maximise your chances and/or to try more than one company, come to BJHAD on a workday before 16:00 and avoid rush hours. 
...
* Some attractions require no ticket (e.g. China Art Museum), allow tourists to enter without a ticket (e.g. Shanghai Museum East) or have an option to easily purchase a ticket on-site (China Railway Museum in Beijing). You don't need to worry about these, but these are rare. 
...
* For many attractions tickets are free but still necessary, which means that they sell out even faster (because they are free). This could be through a website (e.g. National Museum of China in Beijing) or through WeChat (e.g. Shaanxi History Museum in Xi'an).
* So for example, if you want to visit Shaanxi History Museum in Xi'an (tickets on WeChat are released 5 days in advance and they sell out in minutes) and Forbidden City in Beijing (tickets on WeChat are released 7 days in advance, they sell out within an hour, and Chinese phone number is required), you might want to start your trip with Shanghai and a hike on the Great Wall (easy to purchase tickets on their website from outside China). The earliest you can visit Forbidden City is on day 8 of your trip. Conversely, you don't want to schedule your top priorities for your last day in that city. If you fail to get tickets for a particular day, it is nice to have an option to try tomorrow and maybe get the tickets for a day later than expected.
* If you have friends who are Chinese or are in China, they might be able to help. Be sceptical of advice from people who are not currently in China, as things are changing rapidly.
* I did not use any ticket resellers. Of course, it is easier for them to get you a ticket, because they've done it before and they are inside China. But attractions don't like resellers profiting from reselling their tickets, so they are implementing various restrictions to curtail their activity. Resellers don't have magic powers - foreign passport verification with China Railway still takes days, tickets cannot be purchased before they are officially released (typically 3-7 days in advance), and no more tickets can be purchased once they are sold out. On the day of the visit, you might get a refund from a reseller instead of a ticket.
...
* I had to cancel many tickets (including train tickets) during my time in China; it was always very easy to do, and without me asking I automatically got all the refunds. Reshufling your plan during the trip is totally doable, just remember that your passport number is attached to (almost) every ticket. In many cases double booking is not allowed or there are penalties for booking a free ticket and not showing up.
...
* WeChat Mini Programs - you'll need to use them to book tickets for attractions and to order at restaurants. If you don't have a sun-shaped QR code for the Mini Program, you can search for it ("Discover" at the bottom of the screen). The international version of WeChat (from Google Play Store) has a "Translate" function for Mini Programs (in the menu at the top of the screen). There are usage restrictions, don't expect to be able to use a dozen of Mini Programs in Translate mode in a short period of time.
* Some attractions don't have a Mini Program, then you'll need to find their Account on WeChat. Use search ("Discover" at the bottom of the screen) to locate the Account and then "follow" it. Afterwards, you can see all the Accounts you've followed ("Contacts" at the bottom of the screen) under either Official Accounts or Service Accounts. Click on the Account you followed and somewhere there will be a button to book tickets. There is no Translate mode for this. 
* Weather you are booking tickets through a Mini Program or an Acoount, you don't know if it will work until you've successfully paid for the ticket. Sometimes you get as far as approving the payment, and then just as you think you've paid, an error message pops up. Usually the problem is your lack of Chinese National ID Card. If you can't get tickets, carefully re-examine all options on the screen. Perhaps you pressed "Book Tickets" when you should have pressed "Book with Foreign Passport".
* For each ticket you are planning to book on WeChat, figure out how many days in advance you'll be able to book, at what time of the day are the tickets released (17:00 is a popular time, but it could also be 20:00 or any other time), whether you can enter your passport details in advance, and whether you can validate your phone number in advance.
* You'll need to develop confidence to be absolutely sure if you've pressed a button on your touch screen or not. If you've pressed a button once and nothing happens, it might be that something is happening, but there are no visual clues. Often it is better to wait for 30 seconds before pressing the same button again. Any repeated button press might be registered as a new button press on the next screen (the one you cannot see yet) and that might have negative consequences. 
...
**Alipay:**
* You'll need Alipay for payments and transport.
* To use public transport, click on Transport, make sure that the city name on the top of the screen is correct, select Metro or Bus, and press "Get Now" to obtain a travel card. Sometimes there is a choise of more than one travel card, my strategy of always selecting the first option worked well. You only need to do it once in every city. You might need to get a bus card, if you've only taken metro before.
* Didi is integrated into Alipay and it works brilliantly. Since Alipay is also a payment app, paying for rides is seemless.
...
* If you already have an account with 12306 China Railway and you've already validated a copy of your passport, then you might be able to log into your account through Alipay. You'll just need to validate your Chinese phone number. This might or might not work. If it asks you to upload a copy of your passport for verification, your best bet might be to use [https://www.12306.cn/index/](https://www.12306.cn/index/) instead (use the website in Chinese, do not switch to the English version that is not likely to work inside China).
* Whether or not you can purchase train tickets on Alipay, it is the most convenient way to check train times and ticket availability. 
* There is a floating Translate button that is sometimes helpful.
...
* I am always sceptical of "you must do this before you arrive" advice. A country might be a holiday destination for me, but for millions of people it is a normal place to live. I don't need to pre-book a private transfer from an airport, I'll take a bus like the locals do. I don't need to buy an eSIM beforehand, I'll buy a local SIM card from a corner shop. China is different, you must do a lot of things before you arrive. Here are some of the main reasons why: you'll be inside the Great Firewall when you arrive, everything works with National ID Cards which you don't have, digital infrastructure runs on homegrown software (in Chinese) and hardware (apps are now built for [HarmonyOS](https://en.wikipedia.org/wiki/HarmonyOS) not Android).
...
* Even if the permissions requested by the Chinese apps you'll have to install don't bother you, consider bringing a burner smartphone to protect the battery of your beloved phone.
* Realistically you'll need two smartphones. You'll constantly need to translate what's on your screen, and you'll want Google Translate app in camera mode pointed at it. You'll need to scan QR codes that are on your screen. You'll be looking at several mapping apps simultaneously most of the time. You'll be switching between SIM cards and turning your VPN on and off all the time. You won't be able to switch between apps like you normally do, as everything is in one super app. If you've called a taxi before paying your restaurant bill, and now you need to use the same app for the payment, while your phone is trying to put the app to sleep...good luck. 
* Having two smartphones will make a lot of things easier, but as one person (i.e. one passport number) you'll only have one account for each service and you'll be in trouble if something bad happens to that account. I hate to say it, but China is one country where for your first visit you might want to go with somebody instead of going solo. 
* The Great Firewall. I was actually excited about experiencing what it's like to be inside the Great Firewall, and being disconnected from my daily life for the whole trip sounded good to me. But it doesn't work that way. Your banking apps are outside the Great Firewall, and if you can't approve transactions you'll be stuck. You'll be really desperate for Google Translate app in camera mode. You'll want to backup your photos. You might need to google some medical advice. There are two ways you can bypass the Great Firewall - using a foreign SIM you brought with you or using a VPN.
* Set up a VPN before you arrive, do not download VPNs in China. You guessed it, it's better to set up more than one VPN. One of my VPNs worked, but the other one did not. There is no way to know in advance, as both VPNs and VPN blocking technologies are constantly evolving. You might think you don't need a VPN because you have a foreign SIM you brought with you, but if you loose that SIM or if it runs out of pre-paid data, you'll be very stuck. Also turning your VPN on and off is faster than switching between SIMs. So get yourself a VPN, the less popular/advertised one the better.
* At the very least you'll need two SIMs - a foreign SIM that you'll bring with you (for things outside the Great Firewall) and a local Chinese SIM (for things that only work if you are inside the Great Firewall, and you'll need a local phone number for everything). I brought Lebara UK (physical SIM card) with a pre-paid roaming plan that includes China and it worked well (set the Access Point Name (APN) to uk.lebara.mobi before arriving, wap.vodafone.co.uk won't work in China). My Nomad eSIM worked equally well. Any foreign SIM (physical or eSIM) will work, widely advertised expensive eSIMs have no advantages. If anything, physical SIMs have an advantage because you can easily move them between phones. Bring one foreign SIM for each phone you are bringing. 
* I purchased a physical Chinese SIM at the airport, as I wasn't sure if as a tourist I'll have much success with SIM purchasing outside an airport. Both of my foreign SIMs connected to China Unicom, so I bought China Mobile SIM for diversity. Make sure you get an actual Chinese phone number (+86 followed by 11 digits), not just a data package. I was told that the package I paid for included data, phone calls and receiving SMS but not sending them. I totally forgot about it when WeChat asked me to sent an SMS to verify my phone number; my phone balance turned negative and my account got blocked. Luckily you can easily topup your phone balance on WeChat. Get one Chinese SIM per person; we shared one between two people and it was doable but a bit of a pain. 
* On all of your SIMs you'll need a lot more data than you think you'll need - Chinese apps drain your data as fast as your battery.
...
pre-install international versions of apps
wechat - scan qr by friend
wechat music only with chinese account
predownload amaps, etc. all international versions
do oyu want everyone to have your phone number? 


PAYMENTS
2 apps
scan, pay (to be scanned), 
feees
Need banking apps, setting everything up is not enough.
cashless experience
alipay and wechat pay fees.
Wise support alipay
explain payments + payment fees


TRANSLATION - screenshots, menus. google lense. camera mode
...
UK in chinese is 英国.
english version is much longer, so goes off screen


note taking to know what to book on which day



Not perfect setup but redundancy. Google maps broke
an island maybe?
redundancy!!!! don't think "you've got a good setup"
Opening google maps on local sim permanently disabled photos and reviews.
both sims worked well, apart from Chengdu
...
use real name and phone number for everything. real name, passport, phone number



realising you have no ticket - it's your passport
tickets have times of entry, but exit any time, no pressure to leave. plenty of time to queue
...
arriving - online entry form 24h before 
...
hotels - reservations expire at 6pm. some don't accept foreign guests. they will register you with local police. Booking.com
