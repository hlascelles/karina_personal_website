...
* &#9733; Shaanxi History Museum (34.224938, 108.950597). Halls 1, 2 and 3 were my favourite; 6 and 7 were under renovation. This is an outstanding museum and tickets are free, so they are hard to get. See on WeChat how many days in advance they become available, create an itinerary in the WeChat Mini Program (enter date, time and passport numbers) on the morning of the booking day (it doesn't matter when exactly you do it), then press "book" at 17:00 when the tickets are released. If you can't get tickets, explore Xi'an Museum instead.
...
* If you have friends who are Chinese or are in China, they might be able to help. If your friends tell you there is no reason to stress about any tickets, that means it's been a long time since they've last been to a museum. A lot of things have changed recently, due to the Covid-19 pandemic and many other reasons.
...
**Set up (not) your phone before departure:**
* 
...
like locals do - won't work

SIMs+VPN
China mobile sim in shanghai airport. Sending a text to verify wechat disabled my accaunt, 
Nomad eSIM
...
if you run out of data on your foreign sim
...
use real name and phone number for everything

resellers: i did not use any resellers apart from Booking.com

mess-mess
Its all one app, so it is really hard to juggle between tasks. Dont think you know how switching between apps work, these apps are not well written. and your phone might implement battery policy.
Samsung Galaxy "Local battery policy" 
Alwaus wait for a whole after pressing a button, never assume it didnt work.

apps (wechat, alipay, amaps) - you'll need a lot of data, and a lot of battery
packing: 2 phones,2 chargers, 2-3 sims, power banks (might be taken away). look at 2 maps.
burner phone
Phone battery wont last
...
consider buying tickets for wrong days and getting refunds. have backup plans. 
...
hotels - reservations expire at 6pm. some don't accept foreign guests. they will register you with local police.
