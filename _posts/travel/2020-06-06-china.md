...
**On my wishlist:**
* Take a Didi to Shichuan station (29.762306, 106.829761) of Line 4, aiming to arrive just before 6:00am. Then take the first train back into Chongqing with all the commuting farmers. Just do it. If you need more convincing, see some brilliant writing [here](https://www.iprcc.org/article/4H8LaKprz3Z) or (if you must) photos [here](https://www.chinadailyhk.com/hk/article/603670).
...
* Don't forget to pay for your rides. Neither Didi through AliPay nor Pony.ai will charge your card automatically. If you try to take another ride, the app will force you to pay for the previous one first. But it's on you to remember (and figure out how) to pay for your last rides before leaving China.
...
* I changed my drop off location several times during the ride to prolong my experience in the autonomous car. Walking through this area is really boring, so try to end your ride near a metro station. 
...
public transport
Didi.
12306 rail, might work when you have local phone
Use the Transport tab in Alipay to get a Shanghai metro QR code; works without physical card
 Alipay has integration but didnt work, unless verified on website and then add chinese phone number.
...
translation function has a limit
messaging hotels
music. 
...
3-7 days in advance
resellers might not get them either
...
consider buying tickets for wrong days and getting refunds
...
SIMs+VPN
China mobile sim in shanghai airport. Sending a text to verify wechat disabled my accaunt, wechat services to top up using phone number only
Nomad eSIM
...
i did not use any resellers apart from Booking.com
